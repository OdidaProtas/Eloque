...
public class Pronunciation {
     ...
     * 
     * @param audioFile
     * @param phoneticNotation
     * @param dialects
     * @param phoneticSpelling
     */
    public Pronunciation(List<String> dialects, String phoneticNotation, String phoneticSpelling, String audioFile) {
        super();
